                ...
                >
                    {message && !message.includes('/') && (
                        <>
                            ...
                            <p style={{ "fontSize": "0.875rem", "lineHeight": "1.25rem", "color": "#EF4444" }}>{message}</p>
                        </>
                    )}
                </div>
                <div>
                    <p style={{ "marginBottom": "0.75rem", "fontSize": "1.5rem", "lineHeight": "2rem", "color": "#111827" }}>
                        Already have an account? <Link style={{ color: '#3b82f6', textDecoration: 'underline' }} href={"/login"}>Login here</Link>
                    </p>
                </div>
            </div>
        </form>
